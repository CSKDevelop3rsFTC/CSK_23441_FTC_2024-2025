...
@Autonomous(name = "ambienceRR", group = "Autonomous")
public class ambienceRR extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //place specimen
        TrajectoryActionBuilder preload2 = drive.actionBuilder(new Pose2d(-35, -7,0))
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        clawServo.openClaw(),
                        vFourbarServo1.fourBarStartEnter(),
