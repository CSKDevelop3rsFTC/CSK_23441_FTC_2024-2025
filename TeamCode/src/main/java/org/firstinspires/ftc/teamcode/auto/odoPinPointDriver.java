...
public class odoPinPointDriver extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public odoPinPointDriver(I2cDeviceSynchSimple deviceClient, boolean deviceClientIsOwned) {
